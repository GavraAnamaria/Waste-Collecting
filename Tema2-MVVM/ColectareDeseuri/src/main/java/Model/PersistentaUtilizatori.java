...
public class PersistentaUtilizatori {
    ...
    public boolean insert(Utilizator l) {
        String s = "INSERT INTO utilizator (nume , parola, tip) VALUES ( " + " '" + l.getNume() + "' , '"+ l.getParola() + "' , '"+ l.getTip()+"' )";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        Connection connection = null;
        try {
    ...
    public boolean delete(Utilizator l) {
        String s = "DELETE FROM utilizator WHERE nume = '" +l.getNume() +"' AND parola = '"+l.getParola()+ "'";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        Connection connection = null;
        try {
