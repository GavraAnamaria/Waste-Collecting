...
public class CoordonatorGUI  extends JPanel  {
    ...
    public CoordonatorGUI() {
        ...
        Image newimg = img.getScaledInstance(800, 530,  Image.SCALE_SMOOTH);
...
//----------------------------------[ GETTER ]---------------------------------------------------
    ...
    public void setLocCBox(String[] rezultat) {
        this.locatie.setModel(new DefaultComboBoxModel<>(rezultat));
    }
